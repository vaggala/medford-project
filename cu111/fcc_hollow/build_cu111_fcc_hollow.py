...
# this aligns with the 3rd layer from cu111_clean.xyz
# fcc hollow deals with the 3rd layer from the top
z_third_from_top = z_levels[-3]

# find one cu atom in the third layer; idt it matters which but script isn't random.
...
if fcc_atom is None:
    raise ValueError("could not find a cu atom in the third layer :(")
...
write("cu111_fcc_hollow.traj", slab)

print(slab, "Wrote cu111_fcc_hollow.traj")